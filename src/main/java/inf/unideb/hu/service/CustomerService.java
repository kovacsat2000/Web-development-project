...
public interface CustomerService {
    ...
    void updateCustomer(String email, Customer customer) throws UnknownCustomerException, UnknownStoreException, UnknownAddressException, InvalidCustomerException;
}